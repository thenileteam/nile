...
import { content, download, image, nilelogo, notification, product, productloading, promotion } from '../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2 ml-20'>
                    <img src={content} alt="" />
                    <h1 className="text-[32px] font-bold">Content Management</h1>
                </div>
            ...
            <div className="p-6 mt-28 px-32">
                <div className='flex gap-16'>
                    ...
                    <div className='bg-[#FFFFFF] border-2 shadow-sm w-[300px] p-5 rounded-md'>
                        <img src={product} alt="" />
                        <h1 className='text-[#333333] text-[22px] font-bold mt-1'>Product Moderations</h1>
                    </div>
                </div>
            </div>
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0] w-40">Total Products</td>
                    ...
                    <td className="px-2 py-3 text-center bg-[#F5F5F5] text-[#7E76BC] font-extrabold">
                        <Link to="/totalproducts" className="hover:border-[#7E76BC] border-[#f5f5f5] border-b-2 transition duration-300 underline-offset-4 decoration-[2px] inline-block hover:-translate-x-1">View</Link>
                    </td>
                </tr>
                </tbody>
            </table>
