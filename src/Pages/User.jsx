...
import { activity, download, image, nilelogo, notification, useraccount, userswitch, validation, } from '../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2 ml-20'>
                    ...
                    <h1 className="text-[32px] font-bold">User Managemnt</h1>
                </div>
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0] w-40">Total Users</td>
                ...
                {/* Row 2 */}
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0] w-40">Roles & Permission</td>
                ...
                {/* Row 3 */}
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0] w-40">User Activities</td>
