              ...
              <form>
                  <div className='grid grid-cols-2 gap-20'>
                      <div className='space-y-3'>
                          <div>
                              <h1 className='text-left font-bold text-[#333333] text-[20px]'>Product ID</h1>
                              <p className='text-left'>5678</p>
                          </div>
                          <div className="mb-4">
                              <label htmlFor="qunatity" className="block text-[#333333] text-[14px] text-left mb-2">
                              Quantity
                              </label>
                              <input
                              id="quantity"
                      ...
                      <div className='space-y-3'>
                        <div>
                            ...
                            <p className='text-[#6E6E6E] text-left'>Bolarinwa</p>
                        </div>
                        <div>
                            <h1 className='text-left font-bold text-[#333333] text-[20px]'>Product Status</h1>
                        ...
                        <div className="mb-4">
                              <label htmlFor="stocklevel" className="block text-[#333333] text-[14px] text-left mb-2">
                              Stock Level
                              </label>
                              <input
                              id="stock_level"
      ...
      {isFinalConfirmationOpen && (
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300 ${fadeOut ? 'opacity-0' : 'opacity-100'}`}>
          <div className="bg-white p-5 rounded-lg shadow-lg max-w-[200px] w-full transform transition-all duration-300">
            <div>
              <h1 className='text-[16px] font-bold text-[#333333]'>Product Updated</h1>
            </div>
