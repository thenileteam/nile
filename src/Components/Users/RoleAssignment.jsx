...
import { activity, arrowleft, cancel, download, image, nilelogo, notification, preference, userswitch, validation } from '../../assets';
import { Link } from 'react-router-dom';
import Links from '../../Links';
import AssignRole from '../Popups/AssignRole';
import RemoveAccess from '../Popups/RemoveAccess';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2 ml-20'>
                    ...
                    <h1 className="text-[32px] font-bold">Role Assignment</h1>
                </div>
                ...
                {filterDropdownOpen && (
                    <div className="absolute right-10 mt-2 w-[230px] rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none p-5" style={{top: '100%'}}>
                        <div className="py-1 space-y-3" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            ...
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Choose Permission')}>Permission</h1>
                        </div>
                    </div>
                )}
            </div>
           ...
           {popupVisible && (
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    ...
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Role Name</th>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0]">Samuel</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Admin</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Support & Tickets</td>
                    <td className="px-2 py-3 text-[#7E76BC] text-center"><RemoveAccess /></td>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0]">Kunle</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Admin</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Financial Managements</td>
                    <td className="px-2 py-3 text-[#7E76BC] text-center"><RemoveAccess /></td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center gap-3">
                        <input
                            type="checkbox"
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0]">Kunle</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Admin</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Content Managements</td>
                    <td className="px-2 py-3 text-[#7E76BC] text-center"><RemoveAccess /></td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center gap-3">
                        <input
                            type="checkbox"
