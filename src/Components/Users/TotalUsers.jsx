...
import { activity, arrowleft, download, edit, image, nilelogo, notification, preference, userswitch, validation } from '../../assets';
import { Link } from 'react-router-dom';
import Links from '../../Links';
import UserEdit from '../Popups/UserEdit';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2 ml-20'>
                    <Link to="/user"><img src={arrowleft} alt="" /></Link>
                    <h1 className="text-[32px] font-bold">Total Users</h1>
                </div>
                <div className='flex items-center gap-10 ml-[480px]'>
            ...
            <div className="p-6 mt-28 px-32">
                <div className='flex gap-16'>
                    <div className='bg-[#FFFFFF] border-2 shadow-sm w-[300px] p-5 rounded-md'>
                        ...
                        <p className='text-[#6E6E6E]'>Total Users</p>
                    </div>
                    <div className='bg-[#FFFFFF] border-2 shadow-sm w-[300px] p-5 rounded-md'>
                        <img src={validation} alt="" />
                        <h1 className='text-[#333333] text-[22px] font-bold mt-1'>50,0000</h1>
                        <p className='text-[#6E6E6E]'>Assigned Roles</p>
                    </div>
                    <div className='bg-[#FFFFFF] border-2 shadow-sm w-[300px] p-5 rounded-md'>
                        <img src={activity} alt="" />
                        <h1 className='text-[#333333] font-bold text-[24px]'>Activity Logs</h1>
                    </div>
                </div>
            </div>
                ...
                {filterDropdownOpen && (
                    <div className="absolute right-10 mt-2 w-[230px] rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none p-5" style={{top: '100%'}}>
                        <div className="py-1 space-y-3" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input User Name')}>User Name</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input User ID')}>User ID</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Email')}>Email</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Role')}>Role</h1>
           ...
           {/* Popup Component */}
           {popupVisible && (
                <div className="absolute right-10 top-[400px] w-[230px] p-4 bg-white shadow-lg rounded-md">
                    <input 
                        type="text" 
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[14px]">User Name</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">User ID</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Email</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Role</th>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">qariabdu@gmail.com</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Store Owner</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Active</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex justify-center"><UserEdit /></td>
