...
import { add, arrowleft, download, edit, image, nilelogo, notification, preference, saletag, saletag2, storeverified, transaction, trash, uptown, vector } from '../../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">In Stock</td>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Kulev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Lion's Den</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Apparel</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Out Of Stock</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Pending</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex items-center justify-center gap-3">
                        <Edit />
                        <img src={trash} alt="" />
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Kulev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Lion's Den</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Utensils</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">In Stock</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Pending</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex items-center justify-center gap-3">
                        <Edit />
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Kulev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Lion's Den</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Gadget</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Low Stock</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Pending</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex items-center justify-center gap-3">
                        <Edit />
                        <img src={trash} alt="" />
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Kulev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Lion's Den</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Watch</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Out Of Stock</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Pending</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center flex items-center justify-center gap-3">
                        <Edit />
