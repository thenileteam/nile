...
import { arrowleft, download, image, nilelogo, notification, preference, saletag, saletag2, storeverified, transaction, uptown } from '../../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 ml-20'>
                    ...
                    <h1 className="text-[32px] font-bold">Completed Orders</h1>
                </div>
                <div className='flex items-center gap-10 ml-[315px]'>
           ...
           {popupVisible && (
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    ...
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Quantity</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Total Price</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Order Date</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Order Status</th>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Completed</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Completed</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Done</td>
                </tr>
