        ...
        <div className="flex-grow lg:ml-64">
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Store</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Revenue</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Expenses</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Profits</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Year</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Actions</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center flex items-center justify-center gap-2">Bulk Action
                      <div>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Kunlev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">$3000</td>
