        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 ml-20'>
                    ...
                    <img src={wallet2} alt="" />
                    <h1 className="text-[32px] font-bold">Total Invoicings</h1>
                </div>
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[17px]">Invoice ID</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Store Owner</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Amount</th>
                    <th className="px-2 py-3 font-bold text-[17px] text-center">Date</th>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">Unpaid</td>
                    <td className="px-2 py-3 text-[#7E76BC] text-center"><SendReminder /></td>
