...
import { arrowleft, download, image, nilelogo, notification, preference, store, store2, storeverified,  trash, } from '../../assets';
import { Link } from 'react-router-dom';
import Links from '../../Links';
import StoreApprove from '../Popups/StoreApprove';
import StoreReject from '../Popups/StoreReject';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 ml-20'>
                    ...
                    <h1 className="text-[32px] font-bold">Store Approvals</h1>
                </div>
                ...
                {filterDropdownOpen && (
                    <div className="absolute right-10 mt-2 w-[230px] rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none p-5" style={{top: '100%'}}>
                        <div className="py-1 space-y-3" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Store Owner Name')}>Store Owner Name</h1>
                            ...
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Approval Status')}>Approval Status</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('DD/MM/YYR')}>Application Date</h1>
                        </div>
                    </div>
                )}
            </div>
           ...
           {popupVisible && (
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[14px]">Owner Name</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Store Name</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Application Date</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Approval Status</th>
