...
import { arrowleft, download, image, nilelogo, notification, preference, store, store2, storeverified } from '../../assets';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 ml-20'>
                    ...
                    <h1 className="text-[32px] font-bold">Store Analytics</h1>
                </div>
                ...
                {filterDropdownOpen && (
                    <div className="absolute right-10 mt-2 w-[230px] rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none p-5" style={{top: '100%'}}>
                        <div className="py-1 space-y-3" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Number of Visits')}>Visit</h1>
                            ...
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Sales')}>Sales</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Rate')}>Conversion Rate</h1>
                        </div>
                    </div>
                )}
            </div>
           ...
           {popupVisible && (
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[14px]">Store Name</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Visits</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Sales</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Conversion Rates</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Average Order Value</th>
                </tr>
                </thead>
                <tbody>
                {/* Row 1 */}
                <tr className='bg-[#ffffff] shadow-md'>
                    <td className="px-2 py-3 bg-[#E2E8F0]">Kulev Shoes</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">250</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">$3500</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">%35</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">23</td>
                </tr>
