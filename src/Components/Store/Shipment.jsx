...
import { arrowleft, download, image, nilelogo, notification, preference, store, store2, storeverified, truckdelivery } from '../../assets';
import { Link } from 'react-router-dom';
import Links from '../../Links';
import StoreShipment from '../Popups/StoreShipment';
        ...
        <div className="flex-grow lg:ml-64">
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3 ml-20'>
                    ...
                    <img src={truckdelivery} alt="" />
                    <h1 className="text-[32px] font-bold">Shipments</h1>
                </div>
                <div className='flex items-center gap-10 ml-[440px]'>
                ...
                {filterDropdownOpen && (
                    <div className="absolute right-10 mt-2 w-[230px] rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none p-5" style={{top: '100%'}}>
                        <div className="py-1 space-y-3" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                            ...
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Shipment ID')}>Shipment ID</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('DD/MM/YYR')}>Shipment Date</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Carrier')}>Carrier</h1>
                            <h1 className='text-[#6E6E6E] font-bold text-[16px] border-[#6E6E6E] border-2 p-2 rounded-lg cursor-pointer' onClick={() => handleFilterClick('Input Tracking Number')}>Tracking Number</h1>
           ...
           {popupVisible && (
            ...
            <table className=" w-full border-separate border-spacing-y-5">
                ...
                <tr className='text-left bg-[#E2E8F0] shadow-lg'>
                    <th className="px-2 py-3 font-bold text-[14px]">Customer Name</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Shipment ID</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Order ID</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Shipment Date</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Carrier</th>
                    <th className="px-2 py-3 font-bold text-[14px] text-center">Tracking Number</th>
                ...
                <tr className='bg-[#ffffff] shadow-md'>
                    ...
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">231</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">3500</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">05/11/2024</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">FedEx</td>
                    <td className="px-2 py-3 text-[#6E6E6E] text-center">56430000</td>
